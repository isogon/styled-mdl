...
describe('<Slider>', () => {
  ...
  beforeEach(() => {
    slider = shallow(<Slider min={0} max={100} />)
    get = {
      get input() {
  ...
  describe('when value is defined', () => {
    it('calculates percent from the value between min and max', () => {
      slider = shallow(<Slider min={100} max={200} defaultValue={110} />)
  ...
  describe('when value is undefined', () => {
    it('sets the percent to 0', () => {
      slider = shallow(<Slider min={100} max={200} />)
