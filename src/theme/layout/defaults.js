...
export const layoutHeaderIconMargin = 24;
export const layoutDrawerButtonMobileSize = 32;
...
export const layoutHeaderMobileIndent = 16;
export const layoutHeaderDesktopIndent = 40;

export const layoutTabFontSize = 14;
export const layoutTabBarHeight = 48;
export const layoutTabMobilePadding = 12;
export const layoutTabDesktopPadding = 24;
export const layoutTabHighlightThickness = 2;
